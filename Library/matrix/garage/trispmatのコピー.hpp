...
template <typename T>
class CSR : public ltri::SpMat<int> {
...
template <>
class CSR<double> : public ltri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <>
class CSR<float> : public ltri::SpMat<float> {
    int N, M; // N denots #rows; M denots #columns.
    float *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
public:
    CSR(CSRMat *Mat) {
        ...
        N = Mat->N; M = Mat->M;
        int nnz = rptr[N];
        val = utils::SafeMalloc<float>(nnz);
        utils::Convert<double, float>(tval, val, nnz);
        free(tval);
    }
    ~CSR() {
        utils::SafeFree(&val);
    ...
    int GetN() { return N; }
    void SpTRSV(float *in, float *out) {
        for(int i=0; i<N; i++) {
            float t = in[i];
            for(int j=rptr[i]; j<rptr[i+1]; j++) {
                t -= val[j] * out[cind[j]];
...
template <int Iter>
class CSRJa : public ltri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <int Iter>
class CSRAsync : public ltri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
class BCSR : public ltri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
class BJCSR : public ltri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <typename T>
class CSR : public dutri::SpMat<int> {
    int N, M; // N denots #rows; M denots #columns.
    int *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <>
class CSR<double> : public dutri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <>
class CSR<float> : public dutri::SpMat<float> {
    int N, M; // N denots #rows; M denots #columns.
    float *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <int Iter>
class CSRJa : public dutri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
template <int Bnl, int Bnw>
class BCSR : public dutri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
...
class BJCSR : public dutri::SpMat<double> {
    int N, M; // N denots #rows; M denots #columns.
    double *val = nullptr;
    int *cind = nullptr;
    int *rptr = nullptr;
